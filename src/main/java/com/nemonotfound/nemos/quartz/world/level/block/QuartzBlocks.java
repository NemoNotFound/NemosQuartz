...
public class QuartzBlocks {
    ...
    public static final Block QUARTZ_PRESSURE_PLATE = registerPressurePlate("quartz_pressure_plate", Blocks.QUARTZ_BLOCK, BlockSetType.STONE, NoteBlockInstrument.BASEDRUM);
    public static final Block QUARTZ_BUTTON = registerButton("quartz_button", BlockSetType.STONE);
    public static final Block CRACKED_QUARTZ_BRICKS = register("cracked_quartz_bricks", Block::new, BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_BRICKS));
    ...
    public static final Block QUARTZ_POTTED_OPEN_EYEBLOSSOM = register("quartz_potted_open_eyeblossom", (properties -> new QuartzFlowerPot(Blocks.OPEN_EYEBLOSSOM, properties)), flowerPotProperties().randomTicks());
    public static final Block QUARTZ_POTTED_CLOSED_EYEBLOSSOM = register("quartz_potted_closed_eyeblossom", (properties -> new QuartzFlowerPot(Blocks.CLOSED_EYEBLOSSOM, properties)), flowerPotProperties().randomTicks());
    ...
    private static Block registerPressurePlate(String id, Block baseBlock, BlockSetType blockSetType, NoteBlockInstrument noteBlockInstrument) {
    ...
    private static Block registerButton(String id, BlockSetType blockSetType) {
