...
public class QuartzModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(@NonNull BlockModelGenerators blockModelGenerators) {
        ...
        createPottedPlant(blockModelGenerators, Blocks.TORCHFLOWER, QuartzBlocks.QUARTZ_POTTED_TORCHFLOWER, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.OAK_SAPLING, QuartzBlocks.QUARTZ_POTTED_OAK_SAPLING, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.SPRUCE_SAPLING, QuartzBlocks.QUARTZ_POTTED_SPRUCE_SAPLING, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.BIRCH_SAPLING, QuartzBlocks.QUARTZ_POTTED_BIRCH_SAPLING, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.JUNGLE_SAPLING, QuartzBlocks.QUARTZ_POTTED_JUNGLE_SAPLING, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.ACACIA_SAPLING, QuartzBlocks.QUARTZ_POTTED_ACACIA_SAPLING, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.CHERRY_SAPLING, QuartzBlocks.QUARTZ_POTTED_CHERRY_SAPLING, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.DARK_OAK_SAPLING, QuartzBlocks.QUARTZ_POTTED_DARK_OAK_SAPLING, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.PALE_OAK_SAPLING, QuartzBlocks.QUARTZ_POTTED_PALE_OAK_SAPLING, PlantType.NOT_TINTED);
        blockModelGenerators.createNonTemplateModelBlock(QuartzBlocks.QUARTZ_POTTED_MANGROVE_PROPAGULE);
        createPottedPlant(blockModelGenerators, Blocks.CRIMSON_FUNGUS, QuartzBlocks.QUARTZ_POTTED_CRIMSON_FUNGUS, PlantType.NOT_TINTED);
        createNetherRoots(blockModelGenerators, Blocks.CRIMSON_ROOTS, QuartzBlocks.QUARTZ_POTTED_CRIMSON_ROOTS);
        createPottedPlant(blockModelGenerators, Blocks.WARPED_FUNGUS, QuartzBlocks.QUARTZ_POTTED_WARPED_FUNGUS, PlantType.NOT_TINTED);
        createNetherRoots(blockModelGenerators, Blocks.WARPED_ROOTS, QuartzBlocks.QUARTZ_POTTED_WARPED_ROOTS);
        createPottedPlant(blockModelGenerators, Blocks.FERN, QuartzBlocks.QUARTZ_POTTED_FERN, PlantType.TINTED);
        createPottedPlant(blockModelGenerators, Blocks.DANDELION, QuartzBlocks.QUARTZ_POTTED_DANDELION, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.POPPY, QuartzBlocks.QUARTZ_POTTED_POPPY, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.OPEN_EYEBLOSSOM, QuartzBlocks.QUARTZ_POTTED_OPEN_EYEBLOSSOM, PlantType.EMISSIVE_NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.CLOSED_EYEBLOSSOM, QuartzBlocks.QUARTZ_POTTED_CLOSED_EYEBLOSSOM, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.BLUE_ORCHID, QuartzBlocks.QUARTZ_POTTED_BLUE_ORCHID, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.ALLIUM, QuartzBlocks.QUARTZ_POTTED_ALLIUM, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.AZURE_BLUET, QuartzBlocks.QUARTZ_POTTED_AZURE_BLUET, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.RED_TULIP, QuartzBlocks.QUARTZ_POTTED_RED_TULIP, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.ORANGE_TULIP, QuartzBlocks.QUARTZ_POTTED_ORANGE_TULIP, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.WHITE_TULIP, QuartzBlocks.QUARTZ_POTTED_WHITE_TULIP, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.PINK_TULIP, QuartzBlocks.QUARTZ_POTTED_PINK_TULIP, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.OXEYE_DAISY, QuartzBlocks.QUARTZ_POTTED_OXEYE_DAISY, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.CORNFLOWER, QuartzBlocks.QUARTZ_POTTED_CORNFLOWER, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.LILY_OF_THE_VALLEY, QuartzBlocks.QUARTZ_POTTED_LILY_OF_THE_VALLEY, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.WITHER_ROSE, QuartzBlocks.QUARTZ_POTTED_WITHER_ROSE, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.RED_MUSHROOM, QuartzBlocks.QUARTZ_POTTED_RED_MUSHROOM, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.BROWN_MUSHROOM, QuartzBlocks.QUARTZ_POTTED_BROWN_MUSHROOM, PlantType.NOT_TINTED);
        createPottedPlant(blockModelGenerators, Blocks.DEAD_BUSH, QuartzBlocks.QUARTZ_POTTED_DEAD_BUSH, PlantType.NOT_TINTED);
        ...
        createPottedAzalea(blockModelGenerators, QuartzBlocks.QUARTZ_POTTED_AZALEA, Blocks.POTTED_AZALEA);
        createPottedAzalea(blockModelGenerators, QuartzBlocks.QUARTZ_POTTED_FLOWERING_AZALEA, Blocks.POTTED_FLOWERING_AZALEA);
    }
